...
- A API Streams traz uma nova opção para a manipulação de coleções em Java os princípios da programação funcional.
- Stream, trata-se de uma solução poderosa para selecionar coleções de maneira declarativa, ao invés da tradicional e burocrática forma imperativa.
